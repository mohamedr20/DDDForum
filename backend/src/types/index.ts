...
import { UserNotFoundException, EmailAlreadyInUseException, ValidationException, UserNameTakenException, ServerException } from '../errors';
...
type ErrorName = EmailAlreadyInUse | UserNameTaken |UserNotFound |  ValidationError | ServerError
type ExceptionType = UserNameTakenException | EmailAlreadyInUseException | ValidationException | ServerException
...
export type EditUserResponse = SuccessUserResponse | UserNameAlreadyTakenResponse | EmailAlreadyInUseResponse;
